...
export default function Footer() {
  return (
    <footer className="mt-16 bg-gradient-to-br from-emerald-900 via-green-900 to-teal-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 sm:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-base sm:text-lg font-semibold text-emerald-100 mb-4 sm:mb-6">Contact Info</h4>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-300 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                  <div>
                    <p className="text-emerald-200 text-xs sm:text-sm">Email</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-emerald-200 text-xs sm:text-sm">Phone</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-emerald-200 text-xs sm:text-sm mb-2">Address</p>
                    <a 
                      href="https://maps.app.goo.gl/ZCu58bikwGTUqWij7" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-white text-sm sm:text-base leading-relaxed hover:text-emerald-200 transition-colors duration-200"
                    >
                      <div className="font-semibold text-emerald-100 mb-1 hover:text-emerald-50">Dr Prabhu Life Multispeciality Clinics and Hospital</div>
        ...
        <div className="border-t border-emerald-700 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            {/* Social Media */}
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="text-emerald-200 text-sm sm:text-base font-medium">Follow Us:</span>
              <div className="flex items-center gap-2 sm:gap-3">
                <a 
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook" 
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-600 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-colors"
                >
