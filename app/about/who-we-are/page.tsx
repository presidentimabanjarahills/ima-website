...
const title = "Who We Are, Hyderabad";
const ogTitle = "Who We Are | IMA Banjara Hills, Hyderabad";
const description =
  "IMA Banjara Hills is a registered medical association in Hyderabad, Telangana, dedicated to ethical medical practice, public health, and the welfare of doctors in the region.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    type: "website",
    images: [{ url: "/imalogo4.png", width: 384, height: 112, alt: "IMA Banjara Hills" }],
  },
  twitter: {
...
export default function WhoWeArePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-surface via-white to-brand-surface">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-brand-navy via-brand-teal to-brand-teal text-white py-8 sm:py-12 md:py-16">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 leading-tight">
            Who We Are
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-brand-surface max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-8 sm:py-12 md:py-16">
        ...
        <section className="mb-12 sm:mb-16 md:mb-20">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-brand-navy/10 overflow-hidden transform hover:shadow-2xl sm:hover:shadow-3xl transition-all duration-500">
            <div className="bg-gradient-to-br from-brand-navy via-brand-teal to-brand-teal px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative overflow-hidden">
              ...
              <div className="max-w-5xl mx-auto">
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="bg-gradient-to-r from-brand-surface to-brand-surface p-4 sm:p-6 rounded-lg sm:rounded-xl border border-brand-navy/10">
                      <h3 className="text-lg sm:text-xl font-semibold text-brand-navy mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3">
                        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-brand-navy flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mb-12 sm:mb-16 md:mb-20">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-brand-navy/10 overflow-hidden transform hover:shadow-2xl sm:hover:shadow-3xl transition-all duration-500">
            <div className="bg-gradient-to-br from-brand-teal via-brand-teal to-blue-600 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-navy/20 to-transparent"></div>
            ...
            <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
              <div className="max-w-5xl mx-auto">
                <div className="bg-gradient-to-r from-brand-surface to-brand-surface p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-brand-navy/10">
        ...
        <section className="mb-12 sm:mb-16 md:mb-20">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-brand-navy/10 overflow-hidden transform hover:shadow-2xl sm:hover:shadow-3xl transition-all duration-500">
            <div className="bg-gradient-to-br from-brand-teal via-blue-600 to-indigo-600 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-navy/20 to-transparent"></div>
              <div className="relative text-center">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white flex items-center justify-center gap-2 sm:gap-3 mb-2">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                  <div className="bg-gradient-to-br from-brand-surface to-brand-surface p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-brand-navy/10 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <div className="flex items-start gap-3 sm:gap-4 lg:gap-6">
                      <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-brand-navy to-brand-teal rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md sm:shadow-lg">
                        <svg className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                        </svg>
                      </div>
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-brand-navy mb-2 sm:mb-3">Promoting Medical Science</h3>
                  ...
                  <div className="bg-gradient-to-br from-brand-surface to-brand-surface p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-brand-navy/10 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <div className="flex items-start gap-3 sm:gap-4 lg:gap-6">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-brand-navy mb-2 sm:mb-3">Improving Public Health</h3>
                  ...
                  <div className="bg-gradient-to-br from-brand-surface to-brand-surface p-4 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-brand-navy/10 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <div className="flex items-start gap-3 sm:gap-4 lg:gap-6">
                      ...
                      <div>
                        <h3 className="text-lg sm:text-xl font-bold text-brand-navy mb-2 sm:mb-3">Maintaining Medical Profession Dignity</h3>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-brand-navy/10 overflow-hidden transform hover:shadow-2xl sm:hover:shadow-3xl transition-all duration-500">
            <div className="bg-gradient-to-br from-brand-navy via-brand-teal to-brand-teal px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative overflow-hidden">
              ...
              <div className="relative text-center">
                ...
                <p className="text-brand-surface text-sm sm:text-base mt-2">Dr. Prabhukumar Challagali</p>
              </div>
            </div>
            <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12">
              <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
                  ...
                  <div className="lg:col-span-1">
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-brand-navy to-brand-teal rounded-2xl sm:rounded-3xl transform rotate-3"></div>
                      <div className="relative bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl">
                        ...
                        <div className="mt-4 sm:mt-6 text-center">
                          <h3 className="text-lg sm:text-xl font-bold text-brand-navy mb-1">Dr. Prabhukumar Challagali</h3>
                          <p className="text-sm sm:text-base text-brand-navy font-medium mb-2">MBBS, MD, PGDHS</p>
                  ...
                  <div className="lg:col-span-2">
                    <div className="bg-gradient-to-br from-brand-surface via-brand-surface to-brand-surface p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border border-brand-navy/10 shadow-lg">
                      <div className="relative">
                        <div className="absolute top-0 left-0 w-16 h-16 sm:w-20 sm:h-20 bg-brand-surface/30 rounded-full blur-xl"></div>
                        <div className="absolute bottom-0 right-0 w-20 h-20 sm:w-24 sm:h-24 bg-brand-surface/30 rounded-full blur-xl"></div>
                        <div className="relative">
                          <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
                            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-brand-navy to-brand-teal rounded-xl flex items-center justify-center shadow-lg">
                              <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                              </svg>
                            </div>
                            <div>
                              <h3 className="text-lg sm:text-xl font-bold text-brand-navy">President&apos;s Message</h3>
                              <p className="text-sm sm:text-base text-brand-navy">Words from our leader</p>
                            </div>
                          </div>
                          
                          <div className="space-y-4 sm:space-y-6">
                            <div className="bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-brand-navy/10">
                              <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                            ...
                            <div className="bg-gradient-to-r from-brand-surface to-brand-surface p-4 sm:p-6 rounded-xl border border-brand-navy/15">
        ...
        <section className="text-center">
          <div className="bg-gradient-to-br from-brand-navy via-brand-teal to-brand-teal rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 xl:p-12 text-white shadow-xl sm:shadow-2xl transform hover:shadow-2xl sm:hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-brand-navy/20 to-transparent"></div>
            <div className="relative">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">Join Our Mission</h2>
              <p className="text-base sm:text-lg lg:text-xl text-brand-surface mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed font-light">
                Be part of IMA Banjara Hills and contribute to the advancement of healthcare excellence in our community.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
                <Link
                  href="/events"
                  className="bg-white text-brand-navy px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-brand-surface transition-all duration-300 shadow-lg sm:shadow-xl hover:shadow-xl sm:hover:shadow-2xl transform hover:scale-105 hover:-translate-y-1"
                >
                  View Our Events
                </Link>
            <Link
              href="/about/ima"
                  className="border-2 border-white text-white px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-white hover:text-brand-teal transition-all duration-300 shadow-lg sm:shadow-xl hover:shadow-xl sm:hover:shadow-2xl transform hover:scale-105 hover:-translate-y-1"
            >
                  About IMA
            </Link>
          </div>
